...
import com.habiham.tracking.data.api.ApiClientFactory
import com.habiham.tracking.data.api.UnauthorizedHint
...
class AuthRepository(
    ...
    suspend fun register(username: String, password: String): Result<String> {
        ...
        return runCatching {
            ...
            response.message?.takeIf { it.isNotBlank() } ?: "Аккаунт создан."
        }.fold(
